...
import type { CreateTaskInput, PaginatedTasks, Task, TaskFilters, UpdateTaskInput } from '../types';
...
export async function updateTask(id: string, input: UpdateTaskInput, etag?: string): Promise<void> {
